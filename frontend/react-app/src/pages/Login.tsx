...
import { loginUser } from '../api/coding'
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Log in to your AI OA account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 rounded-3xl border border-slate-800 bg-slate-900/50 p-8 backdrop-blur-xl shadow-2xl">
          ...
          <p className="text-center text-xs text-slate-500 mt-6 font-medium">
            ...
            <Link to="/register" className="text-emerald-400 hover:text-emerald-300 transition-colors font-bold">
              Join for Free
            </Link>
          </p>
        </form>
